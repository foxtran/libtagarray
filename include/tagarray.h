...
void dump_container(const void *const container,
...
void save_container_c8(void *const container,
                       const char *const filename) TA_NOEXCEPT;
void save_container_c32(void *const container,
                        const char32_t *const filename) TA_NOEXCEPT;

void delete_container(void *const container) TA_NOEXCEPT;

void *new_record(const uint32_t type_id, const uint32_t n_dimensions,
...
void add_record(void *const container, const char *const tag,
                void *const record) TA_NOEXCEPT;

void *get_record(void *const container, const char *const tag) TA_NOEXCEPT;

void container_remove_record(void *const container,

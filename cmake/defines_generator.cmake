...
function(generate_header LANGUAGE CONFIG_FILENAME HEADER_FILENAME)
  # check LANGUAGEs
  set(SUPPORTED_LANGUAGES C;CXX;Fortran)
  ...
  foreach(line ${CSV})
    ...
    elseif(${LANGUAGE} STREQUAL "CXX")
      string(REGEX REPLACE "^C " "// " line ${line})
      string(REGEX REPLACE " EQ " " = " line ${line})
      string(REGEX REPLACE "^DI " "  inline constexpr int32_t " line ${line})
      string(REGEX REPLACE "^DC " "  inline const std::string " line ${line})
      string(REGEX REPLACE " TA_" " " line ${line})
